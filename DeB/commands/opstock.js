...
module.exports = {
  name: 'opstock', // Command name
  description: 'Display the service stock (op)⭐.', // Command description
  ...
  execute(message) {
        ...
        fs.readdir(`${__dirname}/../opstock/`, function (err, files) {
            ...
            stock.forEach(async function (data) {	
                const acc = fs.readFileSync(`${__dirname}/../opstock/${data}`, 'utf-8');
